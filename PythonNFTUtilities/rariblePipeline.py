...
from scripts.advanced_collectible.create_nft_from_twitch_nftstore import pin_file_to_ipfs
...
def pin_files_and_get_url(user_name, title, path_to_clip, path_to_thumbnail):
    ...
    video_ipfs_hash = pin_file_to_ipfs(path_to_clip, 'video')
    thumbnail_ipfs_hash = pin_file_to_ipfs(path_to_thumbnail, 'image')
